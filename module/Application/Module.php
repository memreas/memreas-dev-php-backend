        ...
        return array(
                'factories' => array(
                        ...
                        'MediaTableGateway' => function  ($sm)
                        {
                            ...
                            $resultSetPrototype->setArrayObjectPrototype(
                                    new Model\Media());
                            return new TableGateway('media', $dbAdapter, null, 
                                    $resultSetPrototype);
                        },
                        ...
                        'EventTableGateway' => function  ($sm)
                        {
                            ...
                            $resultSetPrototype->setArrayObjectPrototype(
                                    new Model\Event());
                            return new TableGateway('event', $dbAdapter, null, 
                                    $resultSetPrototype);
                        },
                        ...
                        'EventMediaTableGateway' => function  ($sm)
                        {
                            ...
                            $resultSetPrototype = new \Zend\Db\ResultSet\ResultSet();
                            $resultSetPrototype->setArrayObjectPrototype(
                                    new Model\EventMedia());
                            return new TableGateway('event_media', $dbAdapter, 
                        ...
                        'FriendMediaTableGateway' => function  ($sm)
                        {
                            ...
                            $resultSetPrototype = new \Zend\Db\ResultSet\ResultSet();
                            $resultSetPrototype->setArrayObjectPrototype(
                                    new Model\FriendMedia());
                            return new TableGateway('friend_media', $dbAdapter, 
                                    null, $resultSetPrototype);
                        },
                        // Transcode related tables
                        'Application\Model\TranscodeTransactionTable' => function  (
                                $sm)
                        {
                            $tableGateway = $sm->get(
                                    'TranscodeTransactionTableGateway');
                        ...
                        'TranscodeTransactionTableGateway' => function  ($sm)
                        {
                            ...
                            $resultSetPrototype->setArrayObjectPrototype(
                                    new TranscodeTransaction());
                            return new TableGateway('transcodetransaction', 
