	...
	public function transcode() {
		try {
			...
			if ($this->type == 'copyright') {
				...
				$cmd = 'nice -' . $this->nice_priority . ' ' . $this->ffmpegcmd . " -nostats -i " . $input_file . ' -profile:v high -level 4.0-pix_fmt yuv420p  -movflags  +faststart -r 25 -hls_list_size 0 -hls_time 2 -hls_allow_cache 0 -hls_segment_filename ' . $transcoded_hls_ts_file . "%03d.ts " . $transcoded_file;
