	...
	public function transcode() {
		try {
			...
			if ($this->type == 'copyright') {
				...
				$this->cmd = 'nice -' . $this->nice_priority . ' ' . $this->ffmpegcmd . ' -re -y -i ' . $input_file . ' -pix_fmt yuv420p ' . ' -profile:v high -level 4.0 ' . ' -hls_list_size 0 ' . ' -hls_time 2 ' . ' -hls_allow_cache 0 ' . " -hls_flags  -hls_key_info_file $keyInfoFile " . ' -hls_segment_filename ' . $transcoded_hls_ts_file . "%03d.ts " . $transcoded_file;
				die ();
