...
class AWSManagerAutoScaler {
	...
	public function __construct($service_locator) {
		Mlog::addone ( __FILE__ . __METHOD__, 'Enter AWSManagerAutoScaler constructor' );
		try {
		...
		Mlog::addone ( __FILE__ . __METHOD__, 'Exit AWSManagerAutoScaler constructor' );
	}
	public function serverReadyToProcessTask() {
		...
		$process_task = false;
		Mlog::addone ( __FILE__ . __METHOD__ . '$server_data [cpu_util] [0]', $server_data ['cpu_util'] [0] );
	...
	function fetchServerData() {
		...
		if ($server_data ['cpu_util'] [0] > 80) {
			Mlog::addone ( __CLASS__ . __METHOD__ . '::$server_data[cpu_util]>80', $server_data ['cpu_util'] );
		}
		return $server_data;
	}
